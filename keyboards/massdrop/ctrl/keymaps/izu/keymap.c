...
#include "config.h"
#include "keyboard.h"
#include "macros/rgb_matrix_mode_macro.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______,
        _______, _______, _______,                   MC_MTRX_CONSTELLATION,                       _______, _______, _______, _______,            _______, _______, _______
    ),
};
...
void keyboard_pre_init_kb() {
    ...
    macros[1] = create_rgb_matrix_mode_macro(MC_MTRX_CONSTELLATION, RGB_MATRIX_CUSTOM_constellation_effect);
